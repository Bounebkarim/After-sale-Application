...
namespace Reclamation.Persistence.Specifications.ReclamationSpecification;
...
public class PaginationSpecification<T> : ISpecification<T>
{
    ...
    private Expression<Func<T, object>> GetOrderByDescendingExpression(string sortBy, string sortOrder)
    {
